...
<style>
 ...
 .overlay-buy-button { background-color: #077bff; color: #000; border: none; border-radius: 8px; height: 40px; padding: 0 10px; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; }
 ...
 .overlay-buy-button .price-container .currency { color: #077bff; }
 ...
 .win-result .text { color: #077bff; font-weight: 500; margin-bottom: 1.5rem; }
 ...
 .footer-btn-buy { flex: 0.9; background-color: #077bff color: #000; }
...
#fast-scratch-button.active {
    background-color: #077bff; /* Verde quando ativo */
    color: #fff;
  ...
  <div class="game-grid">
      ...
      <div class="right-column-container">
          <div class="pix-banner-wrapper">
              <img src="https://ik.imagekit.io/t3rflve8lv/Gemini_Generated_Image_lmy6dblmy6dblmy6.png?updatedAt=1761854461404" alt="Pix na Hora!">
          </div>
          <div data-slot="card">
