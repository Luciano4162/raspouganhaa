...
<head>
    ...
    <title>Suporte Técnico -Mega Raspadinha</title>
...
<main class="main-container">
    <div class="content-wrapper">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10">
            <h2 class="text-center text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight uppercase"> SUPORTE TÉCNICO – Mega Raspadinha</h2>
