...
<style>
 ...
 .lose-result .play-again-btn { background-color: #007bff; color: #000; border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-weight: 700; font-size: 1rem; cursor: pointer; display: inline-flex; align-items: center; gap: 0.5rem; }
 ...
 .win-result .play-again-btn { background-color: #007bff; color: #000; border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-weight: 700; font-size: 1rem; cursor: pointer; display: inline-flex; align-items: center; gap: 0.5rem; }
 ...
 .logged-out-overlay .register-button { background-color: #007bff; color: #111; border: none; border-radius: 8px; padding: 0.75rem 2rem; font-weight: 700; font-size: 1rem; cursor: pointer; text-decoration: none; transition: opacity 0.2s; }
...
@media (max-width: 480px) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const winners = document.querySelector(".live-winners-container");
    if (winners) winners.remove(); // Remove completamente a seção de vencedores
  });
</script>

<div class="live-winners-container">
  <svg class="live-icon-svg" viewBox="0 0 59 60" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
